...
# Signals that mean "entertainment / celebrity / sports / pure gossip"
...
EXCLUDE_TERMS = [
    ...
    # Sports match results / celebrity athletes are out of scope for this blog.
    # Avoid bare ambiguous tokens like "경기"(경제/경기도) or "시즌"(실적시즌).
    "야구", "축구", "농구", "배구", "골프", "테니스", "당구", "탁구",
    "육상", "격투기", "복싱", "UFC", "올림픽", "월드컵", "아시안게임",
    "국가대표", "국가대표팀", "우승", "준우승", "결승전", "8강", "4강",
    "홈런", "스코어", "시합", "선수단",
    "KBO", "K리그", "MLB", "NBA", "EPL", "프리미어리그", "라리가", "세리에A",
    "챔피언스리그", "토트넘", "손흥민", "메시", "LG트윈스", "삼성라이온즈",
    "한화이글스", "기아타이거즈", "NC다이노스", "롯데자이언츠",
    "KT위즈", "인터 마이애미", "케스파컵", "e스포츠", "LCK", "MLS",
    "솔트레이크", "엘에이 fc", "LAFC",
]
